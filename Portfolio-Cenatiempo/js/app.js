...
(function () {
    ...
    $form.addEventListener('submit', (e) => {
        ...
        const nombre_recortado = nombre.trim();
...
gsap.from('.sobre-mi_img', {
    scrollTrigger: {
        trigger: '.sobre-mi_img',
    },
    x: "-=500px",
    autoAlpha: 0,
    duration: 1.5,
...
gsap.from('.sobre-mi_descripcion', {
    scrollTrigger: {
        trigger: '.sobre-mi_descripcion',
    },
    x: "+=500px",
    autoAlpha: 0,
    duration: 1.5,
...
gsap.from('.contacto_container', {
    scrollTrigger: {
        trigger: '.contacto_container',
    },
    scale: 0.7,
    top: -100,
    autoAlpha: 0,
